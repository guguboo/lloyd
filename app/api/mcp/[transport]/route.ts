...
// Money can move whenever LLOYD_MODE ≠ fixture, so in those modes the public MCP
// endpoint requires a bearer API key; fixture stays open (no funds move). A best-effort
