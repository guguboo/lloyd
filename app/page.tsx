      ...
      <div className="relative mx-auto max-w-[1080px] px-6">
        ...
        <section className="border-t border-hairline py-16 sm:py-24">
          ...
          <StaggerReveal className="mt-8 grid gap-x-10 gap-y-4 sm:grid-cols-2">
            <StaggerItem variant="left"><Rule>Coverage never exceeds 50% of the capital pool.</Rule></StaggerItem>
            <StaggerItem variant="left"><Rule>No single provider concentrates more than 10%.</Rule></StaggerItem>
            <StaggerItem variant="left"><Rule>One policy per buyer and provider pair.</Rule></StaggerItem>
            <StaggerItem variant="left"><Rule>Each policy pays out exactly once, enforced by the database.</Rule></StaggerItem>
          </StaggerReveal>
          <Reveal variant="rise">
            <Link
              href="/ledger"
